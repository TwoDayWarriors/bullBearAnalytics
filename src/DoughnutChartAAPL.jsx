...
function DoughnutChartAAPL() {
  const [stockDataDA, setStockDataDA] = useState([]);
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch("https://financialmodelingprep.com/api/v3/balance-sheet-statement/AAPL?apikey=c82da036c18b7efd7bb7262e57a2b187");
...
export default DoughnutChartAAPL;
